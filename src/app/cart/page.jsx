                ...
                <div className="space-y-3 px-7 py-[12px] border-2 rounded-e-md">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                      <button onClick={() => handleDecrement(index)} className="bg-950 px-4 py-2 text-white text-xl rounded-s-md">
                        +
                      </button>
                      <span className="px-9 border-[2px] py-2 border-900"> {item.quantity}</span>
                      <button onClick={() => handleIncrement(index)} className="bg-950 px-4 py-2 text-white text-xl rounded-e-md">
                        -
                      </button>
                    </div>
                  </div>
